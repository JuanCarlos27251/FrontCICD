document.addEventListener('DOMContentLoaded', () => {
    ...
    function loadClientes() {
        fetch('http://a88172aa09cdd482f8c6fc0b5bccfa37-1447733033.us-east-1.elb.amazonaws.com/api/Clientes')
    ...
    function eliminarCliente(id) {
        fetch(`http://a88172aa09cdd482f8c6fc0b5bccfa37-1447733033.us-east-1.elb.amazonaws.com/api/Clientes/${id}`, {
            method: 'DELETE',
        })
        .then(response => {
            if (response.ok) {
    ...
    editForm.addEventListener('submit', (e) => {
        ...
        fetch(`http://a88172aa09cdd482f8c6fc0b5bccfa37-1447733033.us-east-1.elb.amazonaws.com/api/Clientes/${editingClientId}`, {
            method: 'PUT',
